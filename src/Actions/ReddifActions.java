...
public class ReddifActions 
{
		...
		public void test1()
		{
			...
			fullname.sendKeys("Arun");
			
			WebElement mailid = driver.findElement(By.xpath("//table[@id='tblcrtac']/tbody/tr[7]/td[3]/input[1]"));
			
			Actions act=new Actions(driver); //url details in driver.so constructor through pass
